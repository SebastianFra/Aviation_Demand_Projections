...
Country_SSP_Database <- melt(setDT(Country_SSP_Database) ,  measure.vars = measure.values, variable.name = "scenarios")
...
Country_SSP_Database_IE <- melt(setDT(Country_SSP_Database_IE) ,  measure.vars = measure.values, variable.name = "scenarios")
...
References <- melt(setDT(References) ,  measure.vars = measure.values, variable.name = 'scenarios')
...
#interpolate
GDP_data=melt(setDT(GDP_data),id.vars = c("iso","year"))
## interpolate
...
measure.values<-c("SSP1_noCOVID","SSP2_noCOVID","SSP5_noCOVID")
#interpolate
POP_data=melt(setDT(POP_data),id.vars = c("iso","year"))
## interpolate
...
measure.values<-c("SSP1_noCOVID","SSP2_noCOVID","SSP5_noCOVID","SSP1","SSP2","SSP5")
POP_data <- melt(setDT(POP_data) ,  measure.vars = measure.values, variable.name = "scenarios")
setDT(GDP_data)
GDP_data <- melt(setDT(GDP_data) ,  measure.vars = measure.values, variable.name = "scenarios")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
 ...
 setDT(Country_SSP_Database_takeoffs_all)
  Country_SSP_Database_takeoffs_all <- melt(setDT(Country_SSP_Database_takeoffs_all),  id.vars = c("year", "iso_region"), variable.name = "scenarios")
